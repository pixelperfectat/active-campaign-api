...
use Pixelperfect\ActiveCampaign\Hydrator\NoopHydrator;
use Http\Client\HttpClient;
use Pixelperfect\ActiveCampaign\Hydrator\Hydrator;
use Pixelperfect\ActiveCampaign\RequestBuilder;
...
abstract class HttpApi
{
     ...
     */
    protected function validateRequiredParams(array $data, array $requiredParams): void
    {
