...
use Pixelperfect\ActiveCampaign\Http\Message\Authentication\ApiToken;
...
final class HttpClientConfigurator
{
    ...
    public function createConfiguredClient(): HttpClient
    {
        ...
        $plugins[] = new Plugin\HeaderDefaultsPlugin(
            [
                'User-Agent' => 'pixelperfectat/active-campaign (https://github.com/pixelperfectat/active-campaign)',
            ]
        );

        if (null !== $this->apiKey) {
            $plugins[] = new Plugin\AuthenticationPlugin(
                new ApiToken($this->apiKey)
            );
        }
